<?php
    ...
    $name = mysqli_query($koneksi, "SELECT nama FROM users WHERE username = '$username'");
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Dashboard</h2> 
                        <br>  
                        <h3>Selamat Datang <b><?php echo $data['nama']?></b> , di Website Fakultas Komputer </h3>
                        <p>Website ini merupakan layanan bagi mahasiswa Fakultas Komputer. Website ini memberikan layanan untuk memberi informasi berita terkini, menyimpan biodata anda, dan untuk menghubungi dosen </p>
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
